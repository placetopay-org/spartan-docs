...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <div class="flex my-10">
                <a href="{{ url('/docs/installation') }}" title="{{ $page->siteName }} getting started" class="bg-gray-800 hover:bg-gray-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Get Started</a>
        ...
        <img src="{{ url('/assets/images/PicHomeSpartan.svg') }}" alt="{{ $page->siteName }} large logo" class="sm:w-1/2  md:w-2/5 lg:w-2/5  mx-auto mb-6 lg:mb-0 ">
    </div>
    ...
    <div class="md:flex -mx-2 -mx-4">
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            <img src="{{ url('/assets/images/brackets-curly-regular.svg') }}" class="h-12 w-12 fill-current" alt="window icon">
        ...
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            <img src="{{ url('/assets/images/cog-regular.svg') }}" class="h-12 w-12" alt="terminal icon">
        ...
        <div class="mx-3 px-2 md:w-1/3">
            <img src="{{ url('/assets/images/layer-group-regular.svg') }}" class="h-12 w-12" alt="stack icon">
